...
FORBIDDEN = [
    ...
    ("home address",        r"Cura\s+ave|***REMOVED***",        "street address on payslip"),
    ("date of birth",       r"\b17\s+Mar(ch)?\s+1994\b",    "DOB on payslip"),

    # --- Compensation: never public, in any repo ---
    # No leading \b: "R***REMOVED***" has no word boundary between R and 1.
    ...
    ("template author",     r"\bXien\b|***REMOVED***|***REMOVED***|***REMOVED***|***REMOVED***",
...
def read_text(path):
    ...
    the easiest place for something already removed from the markup to survive.
